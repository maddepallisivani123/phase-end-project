    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
                ...
                static void update(string filename)
                {
                    ...
                    string[] arrteacher = System.IO.File.ReadAllLines(filename);
                ...
                static void search(string filename)
                {
                    ...
                    foreach (Teacher t in listTeachers)
                    {
                        if (t.Id == id)
                        {
                            Console.WriteLine("given id {0} is present in the given file", id);
                            Console.WriteLine($"Teacher Id: { t.Id} , Teacher Firstname: { t.FirstName} , Teacher Lastname: { t.LastName} , Teacher Class: { t.CClass} , Teacher Section: { t.Section}");
                            break;
